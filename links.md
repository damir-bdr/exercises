...
* [GopherCon 2017: Aaron Schlesinger - Functional Programming in Go](https://www.youtube.com/watch?v=c8Fwb4KbVJM)

* [Golang UK Conference 2016 - Mat Ryer - Idiomatic Go Tricks](https://www.youtube.com/watch?time_continue=509&v=yeetIgNeIkc)

* [7 common mistakes in Go and when to avoid them by Steve Francia (Docker)](https://www.youtube.com/watch?v=29LLRKIL_TI&t=351s)
...
* [Сокращатель URL на Go и Mongodb](https://4gophers.ru/articles/sokrashchatel-url-na-go-i-mongodb/#.WjKICt9fjCK)

* [Unmarshaling Into an Interface{} and Then Performing Type Assertion](https://stackoverflow.com/questions/35583735/unmarshaling-into-an-interface-and-then-performing-type-assertion)

* [Unmarshaling nested JSON objects in Golang](https://stackoverflow.com/questions/21268000/unmarshaling-nested-json-objects-in-golang?rq=1)

* [Embedded interface](http://golang-examples.tumblr.com/post/132927916289/embedded-interface)

* [Go interfaces & pointers](https://medium.com/@agileseeker/go-interfaces-pointers-4d1d98d5c9c6)

* [Go Best Practices — Error handling](https://medium.com/@sebdah/go-best-practices-error-handling-2d15e1f0c5ee)

* [Method overriding in Go](https://medium.com/random-go-tips/method-overriding-680cfd51ce40)

* [Function and Method Overloading in Golang](http://changelog.ca/log/2015/01/30/golang)

* [Inheritance Semantics in Go](https://tech.t9i.in/2014/01/22/inheritance-semantics-in-go/)

* [Object Oriented Programming in Golang](http://www.tapirgames.com/blog/golang-oo-programming)

* [Higher-order functions vs interfaces in golang](http://aquaraga.github.io/functional-programming/golang/2016/11/19/golang-interfaces-vs-functions.html)

* [Functional Go](https://medium.com/@geisonfgfg/functional-go-bc116f4c96a4)

* [To understand Go’s specification](https://medium.com/golangspec)

* [Adapter pattern](https://medium.com/@matryer/writing-middleware-in-golang-and-how-go-makes-it-so-much-fun-4375c1246e81)

* [Running MongoDB Queries Concurrently With Go](https://www.goinggo.net/2014/02/running-queries-concurrently-against.html)

* [Self-referential functions and the design of options](https://commandcenter.blogspot.ru/2014/01/self-referential-functions-and-design.html)
...
* [Pointer Receivers vs. Value Receivers in Go](http://www.phizzle.space/golang/2017/01/27/go-pointer-receivers-vs-value-receivers.html)

* [Object Oriented Inheritance in Go](http://hackthology.com/object-oriented-inheritance-in-go.html)

* [Functional Go](https://medium.com/@geisonfgfg/functional-go-bc116f4c96a4)

* [go-func (yourself): Making Golang a Little More Functional Part 1](https://mymemorysucks.wordpress.com/2016/09/30/go-func-yourself-making-golang-a-little-more-functional-part-1/)

* [How to delete struct object in go?](https://stackoverflow.com/questions/42066797/how-to-delete-struct-object-in-go)
...
* [Design philosophy of Golang interface type](http://www.golangprograms.com/golang/interface-type/)
...
* [Чистая архитектура в Go-приложении. Часть 1](https://habrahabr.ru/post/269893/)

* [UNDERSTANDING GOLANG INTERFACES](http://kunalkushwaha.github.io/2015/09/11/understanding-golang-interfaces/)

* [Пишем модульную Go программу с плагинами](https://4gophers.ru/articles/plugins/#.WkUE7t99LCJ)
...
* [Web app using Microservices in Go: Part 1 – Design](https://jacobmartins.com/2016/03/14/web-app-using-microservices-in-go-part-1-design/)
...
* [Golang Decorators: Logging & Time Profiling](https://www.packtpub.com/books/content/golang-decorators-logging-time-profiling)

* [Dealing With Import Cycles in Go](http://mantish.com/post/dealing-with-import-cycle-go/)
...
* [Writing Testable Code in Go (golang)](http://relistan.com/writing-testable-apps-in-go/)

* [Practical Persistence in Go: Organising Database Access](http://www.alexedwards.net/blog/organising-database-access)

* [Software adventures and thoughts by Svetlin Ralchev](http://blog.ralch.com/tutorial/)
...
* [Embedded interface](http://golang-examples.tumblr.com/)
...
* [Copying Interface Values In Go](https://www.goinggo.net/2016/05/copying-interface-values-in-go.html)

* [Go Slices: usage and internals](https://blog.golang.org/go-slices-usage-and-internals)

* [Most Popular Golang String Functions](http://www.golangprograms.com/golang/string-functions/)

* [Interfaces in Go Object Oriented Go](https://medium.com/@gianbiondi/interfaces-in-go-59c3dc9c2d98)

* [Go interfaces & pointers](https://medium.com/@agileseeker/go-interfaces-pointers-4d1d98d5c9c6)

* [Golang interface method – pointer receiver or value receiver](https://paradite.com/2015/10/14/golang-interface-method-pointer-receiver-or-value-receiver/)
...
* [An example of the use of a finalizer (the runtime.SetFinalizer function)](https://gist.github.com/deltamobile/6511901) +

* [Iterators in Go](https://ewencp.org/blog/golang-iterators/)

* [Idiomatic Generics in Go](https://bouk.co/blog/idiomatic-generics-in-go/)
...
* [Паттерны параллелизма в Go: Context (перевод)](http://poetofcode.ru/2016/01/09/patternyu-parallelizma-v-go-context.html)

* [How do I reverse an array in Go?](https://stackoverflow.com/questions/19239449/how-do-i-reverse-an-array-in-go)
